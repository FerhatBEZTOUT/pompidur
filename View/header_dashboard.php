...
<body class="vh-100" style="display:flex;
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light nav" aria-label="Third navbar example">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample03">
            ...
            <li class="nav-item">
                <a class="nav-link menuNav" href="../empreints.php">Ouvrages empruntés</a>
                
            </li>

            <li class="nav-item">
                <a class="nav-link menuNav" href="../reservations.php">Salles reservées</a>
                
            </li>

            <li class="nav-item">
                <a class="nav-link menuNav" href="../bd.php">Base de données</a>
                
            </li>

            <li class="nav-item">
                <a class="nav-link menuNav" href="../schemas.php">MCD/MLD</a>
