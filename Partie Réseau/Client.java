		...
		do {
			...
			try {
				...
				if (!rep.equals("o")) {      
					...
					s = new Socket("192.168.1.226", 2004);
				}
				...
				if (msg.equals("IDENTIFY")) {
					...
					if (reponseOK) {
						...
						if (msg.equals("PRIVILIGED")) {
							fermerConn(s,pr,"La porte est ouverte, votre majesté !");   // Utilisateur avec "hasfullaccess==True" dans la BD
							...
							if (reponseOK) {
								...
								if(msg.equals("ReservOK")) {
									...
									do {
										...
										str = sc.nextLine(); // Lecture demande sauvegarde
									...
									if(reponseOK) {
										...
										if (msg.equals("EnregOK")) {
											...
											fermerConn(s,pr,"réponse serveur incompréhensible");
										}
									}
									else {
